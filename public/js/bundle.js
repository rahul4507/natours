    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 5:
          res = _context2.sent;
          // console.log(res);
          (0, _alerts.showAlert)('success', res);
          if (res.data.status === 'success') {
...
var stripe = Stripe('pk_test_51Qq84lRxjI1XJVUy4rhI25BxTAMkgBliZKdvAlLQsFMLGdCmeF1QWps6XHHP6IhLvqPfgwOAlteF1IhlxyyDy3TH00O4GHk7Zu');
